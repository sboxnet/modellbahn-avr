...
__attribute__ ((section(".bldrinit"))) __attribute__((naked)) __attribute__((used))
...
# 125 ".././bootloader-crt0.c" 3
   (*(volatile uint8_t *)(0x003F)) 
# 125 ".././bootloader-crt0.c"
        = 0;

    
# 127 ".././bootloader-crt0.c" 3
   (*(volatile uint16_t *)(0x3D)) 
# 127 ".././bootloader-crt0.c"
      = (
# 127 ".././bootloader-crt0.c" 3
        ((0x2000U) + (4096U) - 1) 
# 127 ".././bootloader-crt0.c"
    ...
    uint8_t* p = (uint8_t*)
# 130 ".././bootloader-crt0.c" 3
                          (0x2000U)
# 130 ".././bootloader-crt0.c"
                                             ;
    do {
        *p++ = 0;
    } while (p != (uint8_t*)
# 133 ".././bootloader-crt0.c" 3
                           ((0x2000U) + (4096U) - 1)
# 133 ".././bootloader-crt0.c"
                                            );
