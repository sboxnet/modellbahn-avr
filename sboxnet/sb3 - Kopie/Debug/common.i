...
__attribute__ ((section(".init2"))) __attribute__((naked))
void com_init2(void) {
    
# 37 ".././common.c" 3
   (*(volatile uint16_t *)(0x3D)) 
# 37 ".././common.c"
      = (
# 37 ".././common.c" 3
        ((0x2000U) + (4096U) - 1) 
...
__attribute__ ((section(".appcrc"))) __attribute__((naked)) __attribute__((unused))
...
# 1 "C:\\Users\\balagi\\Documents\\modellbahn\\avr/avrutilslib/ringbuffer.c" 1
# 22 "C:\\Users\\balagi\\Documents\\modellbahn\\avr/avrutilslib/ringbuffer.c"
void ringbuf_init(struct ring_buffer* a_rb, uint8_t a_size) {
    a_rb->rd = 0;
    a_rb->wr = 0;
    a_rb->size = a_size;
...
#define TIMER_PERIOD (F_CPU / TIMER_PRESCALER / TIMER_FREQ_HZ)
...
uint8_t bitmask(uint8_t bit) {
 static const uint8_t offsmap[8] 
# 95 ".././common.c" 3
...
# 106 ".././common.c"
__attribute__((weak)) void do_init_system(void) {
}




__attribute__((weak)) uint8_t do_reg_read(uint16_t reg, uint16_t* pdata) {
    return 4;
}
...
__attribute__((weak)) uint8_t do_reg_write(uint16_t reg, uint16_t data, uint16_t mask) {
    return 4;
}
...
__attribute__((weak)) uint8_t do_msg(struct sboxnet_msg_header *pmsg) {
    return 2;
}
...
__attribute__((weak)) void do_setup(void) {
}




__attribute__((weak)) void do_main(void) {
}




__attribute__((weak)) void do_before_bldr_activate(void) {
}
...
# 299 ".././common.c"
    ...
    switch (pmsg->cmd) {
        ...
        case 0x13: {
            ...
            eeprom_update_block(&pmsg->data[1], (*(struct bldr_eeprom_t*)0x300).dev_desc[id], n);
            pmsg->opt.len = 0;
            return 0;
        }
        default:
...
# 487 ".././common.c"
    ...
    eeprom_update_word(&(*(struct bldr_eeprom_t*)0x300).productid, g_com.productid);
    eeprom_update_word(&(*(struct bldr_eeprom_t*)0x300).vendorid, g_com.vendorid);
...
# 497 ".././common.c"
                                         ;
            eeprom_update_byte(&(*(struct bldr_eeprom_t*)0x300).dev_desc[0][n], c);
            if (c == 0) {
                break;
            }
        }
...
# 510 ".././common.c" 3
void __vector_86 (void) __attribute__ ((signal,used, externally_visible)) ; void __vector_86 (void) 
# 510 ".././common.c"
                  {
