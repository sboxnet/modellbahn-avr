...
ringbuf_init:
.LFB36:
	.file 3 "C:\\Users\\balagi\\Documents\\modellbahn\\avr/avrutilslib/ringbuffer.c"
	.loc 3 22 0
	.cfi_startproc
.LVL4:
/* prologue: function */
...
.LBB31:
	...
	mov r30,r24
	ldi r31,0
	subi r30,lo8(-(offsmap.4476))
	sbci r31,hi8(-(offsmap.4476))
/* #APP */
 ;  96 ".././common.c" 1
	lpm r24, Z
...
.LBB94:
	...
	.loc 1 299 0
	mov __tmp_reg__,r31
	ldi r31,lo8(g_dev_state)
	mov r10,r31
	ldi r31,hi8(g_dev_state)
	mov r11,r31
	mov r31,__tmp_reg__
.LBB95:
	.loc 1 363 0
...
.LFE57:
	.size	main, .-main
	.section	.progmem.data.offsmap.4476,"a",@progbits
	.type	offsmap.4476, @object
	.size	offsmap.4476, 8
offsmap.4476:
	.byte	1
	.byte	2
...
.Letext0:
	...
	.file 6 "C:\\Program Files (x86)\\Atmel\\Studio\\7.0\\Packs\\Atmel\\XMEGAA_DFP\\1.2.141\\include/avr/iox64a4u.h"
	.file 7 "C:\\Users\\balagi\\Documents\\modellbahn\\avr/avrutilslib/ringbuffer.h"
	.file 8 ".././sboxnet-struct.h"
	.file 9 ".././sboxnet.h"
...
.Ldebug_macro0:
	...
	.uleb128 0x3b
	.long	.LASF4270
	.file 30 "C:\\Users\\balagi\\Documents\\modellbahn\\avr/avrutilslib/defines.h"
	.byte	0x3
	.uleb128 0x3d
	.uleb128 0x1e
	.byte	0x5
