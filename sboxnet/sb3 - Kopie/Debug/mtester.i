...
__attribute__ ((section(".fwheader"))) __attribute__((naked)) __attribute__((unused)) void firmware_header(void) { __asm__ __volatile__ ( ".long %[magic]\n" ".word %[productid]\n" ".word %[vendorid]\n" ".word %[bldrversion]\n" ".word %[appversion]\n" ".zero 20\n" : : [magic] "i" ((((uint32_t)('A') << 24)|((uint32_t)('n') << 16)|((uint32_t)('b') << 8)|('S'))), [productid] "i" (0xa123), [vendorid] "i" (0x5566), [bldrversion] "i" (0x0004), [appversion] "i" (0x0200) ); }




#define TIMER_PERIOD (32000000 / 1024 -1)

#define NUM_STEPS 3

volatile int8_t step = 3 -1;
...
# 53 ".././mtester.c"
    ...
    g_com.productid = 0xa123;

    g_com.vendorid = 0x5566;

    g_com.firmware_version = 0x0200;

    g_com.capabilities = 0x0040;
